...
- `number_of_instances`: A class attribute that tracks the number of `Rectangle` instances created.
- `print_symbol`: A class attribute representing the symbol used to print the rectangle.
"""
