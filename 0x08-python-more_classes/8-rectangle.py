...
class Rectangle:
    ...
    - `number_of_instances`: A class attribute that keeps track of the N `Rectangle` created.
    ...
    def width(self, value):
        """
        A setter method for the width attribute. It validates that the width is a + integer.
    ...
    def height(self, value):
        """
        A setter method for the height attribute. It validates that the height is + integer.
    ...
    def __repr__(self):
        """
        Returns a string representation of the rectangle that can be recreate.
