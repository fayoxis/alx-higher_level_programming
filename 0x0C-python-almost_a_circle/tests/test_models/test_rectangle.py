...
and 'height'"
    ...
    def test_width_height_2(self):
        """ example11: the Test for width and height ranges"""
    ...
    def test_area_1(self):
        """ example12: the Test area of program"""
        r1 = Rectangle(3, 2)
        r2 = Rectangle(2, 10)
    ...
    def test_area_2(self):
        """ example13: it Checking if return value is an area method """
        r1 = Rectangle(2, 2)
    ...
    def test_area_no_args(self):
        """ example14: Test area method with no arguments """
        r = Rectangle(5, 6)
        with self.assertRaises(TypeError) as e:
            Rectangle.area()
    ...
    def test_basic_display_2(self):
        """example16: the Test string printed """
    ...
    def test_display_4(self):
        """ example1: the Test string printed """
        r1 = Rectangle(3, 2)
        result = "###\n###\n"
        with patch('sys.stdout', new=StringIO()) as str_out:
            r1.display()
